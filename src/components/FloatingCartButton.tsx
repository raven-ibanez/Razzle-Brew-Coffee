  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <span className="absolute -top-2 -right-2 bg-white text-razzle-dark text-[10px] rounded-full h-5 w-5 flex items-center justify-center font-bold border-2 border-razzle-gold shadow-lg">
          {itemCount}
        </span>
      </div>
    </button>
