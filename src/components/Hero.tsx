...
const Hero: React.FC = () => {
  return (
    <section className="relative overflow-hidden bg-razzle-dark py-24 px-4 border-b border-white/5">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(212,196,145,0.1),transparent_50%)]" />
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <h1 className="text-5xl md:text-7xl font-brand font-bold text-white mb-8 animate-fade-in flex flex-col items-center">
          <span className="text-razzle-gold text-[10px] md:text-sm tracking-[0.8em] uppercase mb-4 opacity-70">Experience the</span>
          <span className="logo-tracking text-4xl md:text-7xl">RAZZLE BREW</span>
          <span className="h-1 w-24 bg-razzle-gold mt-6 rounded-full" />
        </h1>
        <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto animate-slide-up font-medium tracking-wide">
